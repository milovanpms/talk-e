...
display via I2C, audio via I2S and GPIOs for buttons and feedback. We picked an *S3* 
for its built-in PSRAM, which we needed for audio buffering.
...
| Charging | TP4056 | 1A charge controller |
| Protection | DW01A + FS8205A | Overvoltage, overdischarge, short-circuit |
| Regulation | AMS1117-3.3 | 3.3V for logic |
